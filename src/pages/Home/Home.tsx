        ...
        <div className="align-div">
          <div className="flex-div">
            ...
            <div className="subtitle-text">
              <ParagraphText>
                With Therfen, you can get assisted Shopping services from your
                favourite stores abroad, and have us deliver it to you
                seamlessly.
              </ParagraphText>
            </div>
          </div>
      ...
      <div className="faq">
        ...
        <FlexContainer className="faq-list">
          ...
          <ImageList
            ...
            contentText={["One that purchase items whenever the need arises "]}
          />
          <ImageList
