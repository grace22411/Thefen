...
import { loginCall } from "../../pages/Login/LoginService";
...
const LoginModal = ({
  ...
  return (
    <Modal
      ...
      visible={isModlaVisible.id === "loginModal"}
      onOk={() => setIsModalVisible({ id: "" })}
      onCancel={() => setIsModalVisible({ id: "" })}
      footer={null}
    >
