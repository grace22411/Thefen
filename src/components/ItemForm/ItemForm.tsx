  ...
  return (
    <div className="url-form-section">
      ...
      <div className="additional-info">
        <Header3 fontSize="1.1rem" color={Colors.blueColor}>
          Additional Info
        </Header3>
        <ParagraphText
          weight="100"
        ...
        >
          In order for us to deliver the exact items, we would need you to feel
          some info where applicable
        </ParagraphText>
      </div>
      <div className="input-group input-group-flex">
        <div className="input-group-div flex-1">
        ...
        <div className="input-group-div flex-1">
          ...
          <div className="input-box">
            <input onChange={handleChange} data-index={index} name="color" />
          </div>
        </div>
      </div>
      <div className="input-group input-group-flex">
        <div className="input-group-div flex-1">
          <span>
            Should in case our predefined info area doesn't meet your product
            description, please give a clear description of the item.
          </span>
          <div className="input-box">
            <textarea data-index={index} name="description"></textarea>
          </div>
        </div>
      </div>
